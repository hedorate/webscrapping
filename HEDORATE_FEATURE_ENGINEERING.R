...
HOUSING_MODEL<-lm(PRICE ~ BED + BATH + LA + LD + AGE + POOL_ABOVE + POOL_IN + GAR_DOUBLE + GAR_SINGLE + BASEMENT_FINISH + BRICK + STONE + CERAMIC + HARDWOOD + HIGHWAY + NOBACK + RESIDENTIAL + PUBLICT + TYPE + YOS + CITY ,data = YY)
